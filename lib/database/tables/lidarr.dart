...
import 'package:zagreus/modules/lidarr/core/api/data/metadata.dart';
import 'package:zagreus/modules/lidarr/core/api/data/qualityprofile.dart';
import 'package:zagreus/modules/lidarr/core/api/data/rootfolder.dart';
import 'package:zagreus/vendor.dart';

enum LidarrDatabase<T> with ZagTableMixin<T> {
  ...
  @override
  ZagTable get table => ZagTable.lidarr;
