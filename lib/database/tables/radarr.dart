...
import 'package:zagreus/modules/radarr/core/types/filter_movies.dart';
import 'package:zagreus/modules/radarr/core/types/filter_releases.dart';
import 'package:zagreus/modules/radarr/core/types/sorting_movies.dart';
import 'package:zagreus/modules/radarr/core/types/sorting_releases.dart';
import 'package:zagreus/vendor.dart';

enum RadarrDatabase<T> with ZagTableMixin<T> {
  NAVIGATION_INDEX<int>(0),
  NAVIGATION_INDEX_MOVIE_DETAILS<int>(0),
  NAVIGATION_INDEX_ADD_MOVIE<int>(0),
  NAVIGATION_INDEX_SYSTEM_STATUS<int>(0),
  DEFAULT_VIEW_MOVIES<ZagListViewOption>(ZagListViewOption.BLOCK_VIEW),
  ...
  @override
  ZagTable get table => ZagTable.radarr;
