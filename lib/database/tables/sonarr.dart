...
import 'package:zagreus/modules/sonarr/core/types/filter_releases.dart';
import 'package:zagreus/modules/sonarr/core/types/filter_series.dart';
import 'package:zagreus/modules/sonarr/core/types/monitor_status.dart';
import 'package:zagreus/modules/sonarr/core/types/sorting_releases.dart';
import 'package:zagreus/modules/sonarr/core/types/sorting_series.dart';
import 'package:zagreus/types/list_view_option.dart';
import 'package:zagreus/vendor.dart';

enum SonarrDatabase<T> with ZagTableMixin<T> {
  ...
  DEFAULT_VIEW_SERIES<ZagListViewOption>(ZagListViewOption.BLOCK_VIEW),
  ...
  @override
  ZagTable get table => ZagTable.sonarr;
