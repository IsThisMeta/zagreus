...
enum ZagreusDatabase<T> with ZagTableMixin<T> {
  ...
  DOWNLOADS_BUTTON_ENABLED<bool>(false),
  ...
  LIDARR_WEBHOOK_ON_RENAME<bool>(false),
  LIDARR_WEBHOOK_ON_ARTIST_ADD<bool>(true),
  LIDARR_WEBHOOK_ON_ARTIST_DELETE<bool>(false),
  LIDARR_WEBHOOK_ON_ALBUM_DELETE<bool>(false),
  LIDARR_WEBHOOK_ON_HEALTH_ISSUE<bool>(false),
  LIDARR_WEBHOOK_ON_HEALTH_RESTORED<bool>(false),
  LIDARR_WEBHOOK_INCLUDE_HEALTH_WARNINGS<bool>(false),
  LIDARR_WEBHOOK_ON_APPLICATION_UPDATE<bool>(false),
  LIDARR_WEBHOOK_ON_DOWNLOAD_FAILURE<bool>(false),
  LIDARR_WEBHOOK_ON_IMPORT_FAILURE<bool>(false),
  // Lidarr toast events
  ...
  // Prowlarr global toggles
  PROWLARR_PUSH_ENABLED<bool>(true),
  PROWLARR_TOAST_ENABLED<bool>(true),
  ...
  // Prowlarr toast events
  PROWLARR_TOAST_ON_GRAB<bool>(true),
  PROWLARR_TOAST_ON_HEALTH_ISSUE<bool>(true),
  PROWLARR_TOAST_ON_HEALTH_RESTORED<bool>(true),
  PROWLARR_TOAST_ON_APPLICATION_UPDATE<bool>(false),
  // Seerr notifications
