...
class ZagListViewModalBuilder extends StatelessWidget {
  final int itemCount;
  final Widget Function(BuildContext, int) itemBuilder;
  final ZagBottomActionBar? actionBar;
  final ZagAppBar? appBar;
  final double? appBarHeight;
  final double? itemExtent;

  const ZagListViewModalBuilder({
    Key? key,
  ...
  EdgeInsets _padding(BuildContext context) {
    ...
    return EdgeInsets.fromLTRB(
      ...
      appBar != null
          ? ZagUI.MARGIN_H_DEFAULT_V_HALF.top
          : _padding.top + _viewInsets.top + ZagUI.MARGIN_H_DEFAULT_V_HALF.top,
      _padding.right + _viewInsets.right,
      actionBar != null
          ? 0
          : _padding.bottom +
              _viewInsets.bottom +
              ZagUI.MARGIN_H_DEFAULT_V_HALF.bottom,
    );
  }
}
