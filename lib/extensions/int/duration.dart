...
extension IntegerAsDurationExtension on int? {
  ...
  String asWordDuration({
    ...
    if (this == null || this! <= 0) return 'zagreus.Unknown'.tr();
    ...
    if (hours > 1) {
      return 'zagreus.Hours'.tr(args: [hours.toString()]);
    }

    final minutes = seconds ~/ _MINUTE_IN_SECONDS;
    if (minutes > 0) {
      return 'zagreus.Minutes'.tr(args: [minutes.toString()]);
    }

    return 'zagreus.Seconds'.tr(args: [seconds.toString()]);
  }
