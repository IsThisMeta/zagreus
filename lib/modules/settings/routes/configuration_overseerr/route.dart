...
class _State extends State<ConfigurationOverseerrRoute>
  ...
  Widget _renameInstance() {
    ...
    return ZagBlock(
      ...
      body: [
        TextSpan(
          text: 'Change the name of ${ZagModule.OVERSEERR.title} $instanceName',
        ),
      ],
      ...
      onTap: () async {
        ...
        ZagInstanceContext().setActiveInstance('overseerr', newKey);
        ...
        showZagSuccessSnackBar(
          ...
          message: '${ZagModule.OVERSEERR.title} is now "$newName"',
        );
