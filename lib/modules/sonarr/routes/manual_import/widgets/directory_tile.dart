...
class SonarrManualImportDirectoryTile extends StatefulWidget {
  final SonarrFileSystemDirectory directory;

  const SonarrManualImportDirectoryTile({
    Key? key,
...
class _State extends State<SonarrManualImportDirectoryTile> {
  ZagLoadingState _loadingState = ZagLoadingState.INACTIVE;

  @override
  Widget build(BuildContext context) {
    SonarrFileSystemDirectory _dir = widget.directory;
