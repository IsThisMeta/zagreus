...
class _State extends State<TautulliSearchSearchResults> {
  ...
  List<Widget> _movies(List<TautulliSearchResult> movies) => [
        const ZagHeader(text: 'movies'),
        if (movies.isEmpty) const ZagMessage(text: 'No Results Found'),
  ...
  List<Widget> _series(List<TautulliSearchResult> series) => [
        const ZagHeader(text: 'series'),
        if (series.isEmpty) const ZagMessage(text: 'No Results Found'),
  ...
  List<Widget> _seasons(List<TautulliSearchResult> seasons) => [
        const ZagHeader(text: 'seasons'),
        if (seasons.isEmpty) const ZagMessage(text: 'No Results Found'),
  ...
  List<Widget> _episodes(List<TautulliSearchResult> episodes) => [
        const ZagHeader(text: 'episodes'),
        if (episodes.isEmpty) const ZagMessage(text: 'No Results Found'),
  ...
  List<Widget> _artists(List<TautulliSearchResult> artists) => [
        const ZagHeader(text: 'artists'),
        if (artists.isEmpty) const ZagMessage(text: 'No Results Found'),
  ...
  List<Widget> _albums(List<TautulliSearchResult> albums) => [
        const ZagHeader(text: 'albums'),
        if (albums.isEmpty) const ZagMessage(text: 'No Results Found'),
  ...
  List<Widget> _tracks(List<TautulliSearchResult> tracks) => [
        const ZagHeader(text: 'tracks'),
        if (tracks.isEmpty) const ZagMessage(text: 'No Results Found'),
  ...
  List<Widget> _collections(List<TautulliSearchResult> collections) => [
        const ZagHeader(text: 'collections'),
        if (collections.isEmpty) const ZagMessage(text: 'No Results Found'),
