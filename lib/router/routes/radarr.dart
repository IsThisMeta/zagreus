...
import 'package:zagreus/api/radarr/models/movie/movie.dart';
import 'package:zagreus/modules.dart';
import 'package:zagreus/modules/radarr/core/state.dart';
import 'package:zagreus/modules/radarr/routes/add_movie/route.dart';
import 'package:zagreus/modules/radarr/routes/add_movie_details/route.dart';
import 'package:zagreus/modules/radarr/routes/edit_movie/route.dart';
import 'package:zagreus/modules/radarr/routes/history/route.dart';
import 'package:zagreus/modules/radarr/routes/manual_import/route.dart';
import 'package:zagreus/modules/radarr/routes/manual_import_details/route.dart';
import 'package:zagreus/modules/radarr/routes/movie_details/route.dart';
import 'package:zagreus/modules/radarr/routes/queue/route.dart';
import 'package:zagreus/modules/radarr/routes/radarr/route.dart';
import 'package:zagreus/modules/radarr/routes/releases/route.dart';
import 'package:zagreus/modules/radarr/routes/system_status/route.dart';
import 'package:zagreus/modules/radarr/routes/tags/route.dart';
import 'package:zagreus/router/routes.dart';
import 'package:zagreus/vendor.dart';

enum RadarrRoutes with ZagRoutesMixin {
  HOME('/radarr'),
  ADD_MOVIE('add_movie'),
  ...
  @override
  ZagModule get module => ZagModule.RADARR;
