...
import 'package:zagreus/api/tautulli/types.dart';
import 'package:zagreus/modules.dart';
import 'package:zagreus/modules/tautulli/core/state.dart';
import 'package:zagreus/modules/tautulli/routes/activity_details/route.dart';
import 'package:zagreus/modules/tautulli/routes/check_for_updates/route.dart';
import 'package:zagreus/modules/tautulli/routes/graphs/route.dart';
import 'package:zagreus/modules/tautulli/routes/history_details/route.dart';
import 'package:zagreus/modules/tautulli/routes/ipaddress_details/route.dart';
import 'package:zagreus/modules/tautulli/routes/libraries/route.dart';
import 'package:zagreus/modules/tautulli/routes/libraries_details/route.dart';
import 'package:zagreus/modules/tautulli/routes/logs/route.dart';
import 'package:zagreus/modules/tautulli/routes/logs_logins/route.dart';
import 'package:zagreus/modules/tautulli/routes/logs_newsletters/route.dart';
import 'package:zagreus/modules/tautulli/routes/logs_notifications/route.dart';
import 'package:zagreus/modules/tautulli/routes/logs_plex_media_scanner/route.dart';
import 'package:zagreus/modules/tautulli/routes/logs_plex_media_server/route.dart';
import 'package:zagreus/modules/tautulli/routes/logs_tautulli/route.dart';
import 'package:zagreus/modules/tautulli/routes/media_details/route.dart';
import 'package:zagreus/modules/tautulli/routes/recently_added/route.dart';
import 'package:zagreus/modules/tautulli/routes/search/route.dart';
import 'package:zagreus/modules/tautulli/routes/statistics/route.dart';
import 'package:zagreus/modules/tautulli/routes/synced_items/route.dart';
import 'package:zagreus/modules/tautulli/routes/tautulli/route.dart';
import 'package:zagreus/modules/tautulli/routes/users_details/route.dart';
import 'package:zagreus/router/routes.dart';
import 'package:zagreus/vendor.dart';

enum TautulliRoutes with ZagRoutesMixin {
  HOME('/tautulli'),
  ...
  @override
  ZagModule get module => ZagModule.TAUTULLI;
