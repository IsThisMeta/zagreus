...
import 'package:zagreus/modules/settings/routes/configuration_seerr/pages/connection_details.dart';
import 'package:zagreus/modules/settings/routes/configuration_seerr/pages/headers.dart';
import 'package:zagreus/modules/settings/routes/configuration_seerr/route.dart';
...
enum SettingsRoutes with ZagRoutesMixin {
  ...
  CONFIGURATION_SEERR('seerr'),
  CONFIGURATION_SEERR_CONNECTION_DETAILS('connection_details'),
  CONFIGURATION_SEERR_CONNECTION_DETAILS_HEADERS('headers'),
  ...
  GoRoute get routes {
    switch (this) {
      ...
      case SettingsRoutes.CONFIGURATION_SEERR:
        return route(widget: const ConfigurationSeerrRoute());
      case SettingsRoutes.CONFIGURATION_SEERR_CONNECTION_DETAILS:
        return route(widget: const ConfigurationSeerrConnectionDetailsRoute());
      case SettingsRoutes.CONFIGURATION_SEERR_CONNECTION_DETAILS_HEADERS:
        return route(
          widget: const ConfigurationSeerrConnectionDetailsHeadersRoute(),
        );
    ...
    switch (this) {
      ...
      case SettingsRoutes.CONFIGURATION:
        return [
          ...
          SettingsRoutes.CONFIGURATION_SEERR.routes,
      ...
      case SettingsRoutes.CONFIGURATION_SEERR:
        return [
          SettingsRoutes.CONFIGURATION_SEERR_CONNECTION_DETAILS.routes,
        ];
      case SettingsRoutes.CONFIGURATION_SEERR_CONNECTION_DETAILS:
        return [
          SettingsRoutes.CONFIGURATION_SEERR_CONNECTION_DETAILS_HEADERS.routes,
        ];
      case SettingsRoutes.CONFIGURATION_RADARR:
        return [
