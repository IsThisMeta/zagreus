...
TautulliSearchResult _$TautulliSearchResultFromJson(
        Map<String, dynamic> json) =>
    TautulliSearchResult(
      mediaType:
          TautulliUtilities.mediaTypeFromJson(json['media_type'] as String?),
      subMediaType: TautulliUtilities.mediaTypeFromJson(
          json['sub_media_type'] as String?),
...
Map<String, dynamic> _$TautulliSearchResultToJson(
  ...
  writeNotNull('min_year', instance.minYear);
  writeNotNull('max_year', instance.maxYear);
