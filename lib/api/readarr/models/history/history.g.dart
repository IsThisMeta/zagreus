...
ReadarrHistory _$ReadarrHistoryFromJson(Map<String, dynamic> json) =>
    ReadarrHistory(
      ...
      records: (json['records'] as List<dynamic>?)
          ?.map((e) => ReadarrHistoryRecord.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$ReadarrHistoryToJson(ReadarrHistory instance) {
