...
class SonarrAPI {
  ...
  factory SonarrAPI({
    ...
    return SonarrAPI._internal(
      ...
      manualImport: SonarrCommandHandlerManualImport(_dio),
  ...
  factory SonarrAPI.from({
    ...
    return SonarrAPI._internal(
      ...
      manualImport: SonarrCommandHandlerManualImport(client),
  ...
  final SonarrCommandHandlerManualImport manualImport;
