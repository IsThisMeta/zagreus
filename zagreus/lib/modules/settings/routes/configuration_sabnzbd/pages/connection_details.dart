  ...
  Widget _connectionStatus() {
    ...
    return ValueListenableBuilder<String?>(
      ...
      builder: (context, ssid, _) {
        ...
        final hasSsids = profile.sabnzbdLocalSsids.trim().isNotEmpty;
        ...
        final effectiveHost = profile.effectiveSabnzbdHost();
        final networkLabel = ssid ?? 'network.UnknownSsid'.tr();
        final usingLocal = effectiveHost == profile.sabnzbdLocalHost;
